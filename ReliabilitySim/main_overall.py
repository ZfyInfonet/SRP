...
df_1.to_csv(f'./results/fig1_CDF.csv', header=False, index=False, sep=',')
df_2.to_csv(f'./results/fig1.csv', header=False, index=False, sep=',')
df_3.to_csv(f'./results/BWtest.csv', header=False, index=False, sep=',')
