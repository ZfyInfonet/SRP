...
x_row = [0.1, 0.12, 0.14, 0.16, 0.18, 0.2]
fig_x_num = 101
...
df_1.to_csv(f'./results/Fig2a_n{node_num}e{edge_p}a{arrive_rate}r{req_num}.csv',
            header=False, index=False, sep=',')
df_2 = pd.DataFrame(dataFaultNum)
df_2.to_csv(f'./results/Fig2b_n{node_num}e{edge_p}a{arrive_rate}r{req_num}.csv',
            header=False, index=False, sep=',')
